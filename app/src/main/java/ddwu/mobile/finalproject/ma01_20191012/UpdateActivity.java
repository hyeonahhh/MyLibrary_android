...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (book.getPlusimageFileName() == null) {
            ...
            Log.i("hyeonah", "파일2 이름이 null");
        }
        else {
            Log.i("hyeonah", "여기도 돌아가나? " + book.getPlusimageFileName());
            if (book.getPlusType() == 1) {
                ...
                Bitmap bitmap = BitmapFactory.decodeFile(book.getPlusimageFileName());//경로를 통해 비트맵으로 전환
